...
func _ready():
	...
	GP.Ads.fullscreen_close.connect(func(args): GP.Logger.info("fullscreen close", args[0]))
	GP.Ads.preloader_start.connect(func(): GP.Logger.info("preloader start"))
	GP.Ads.preloader_close.connect(func(args): GP.Logger.info("preloader close", args[0]))
	...
	GP.Ads.rewarded_close.connect(func(args): GP.Logger.info("rewarded close", args[0]))
