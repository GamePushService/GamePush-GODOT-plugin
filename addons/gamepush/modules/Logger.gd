...
func info(arg1="", arg2="", arg3="", arg4="") -> void:
	if OS.get_name() == "Web":
		gp.logger.info(String(arg1), String(arg2), String(arg3), String(arg4))
	else:
		print("INFO:", arg1, arg2, arg3, arg4)

func warn(arg1="", arg2="", arg3="", arg4="") -> void:
	if OS.get_name() == "Web":
		gp.logger.warn(String(arg1), String(arg2), String(arg3), String(arg4))
	else:
		push_warning(arg1, arg2, arg3, arg4)
		
func error(arg1="", arg2="", arg3="", arg4="") -> void:
	if OS.get_name() == "Web":
		gp.logger.error(String(arg1), String(arg2), String(arg3), String(arg4))
	else:
		push_error("INFO:", arg1, arg2, arg3, arg4)

func log(arg1="", arg2="", arg3="", arg4="") -> void:
	if OS.get_name() == "Web":
		gp.logger.log(String(arg1), String(arg2), String(arg3), String(arg4))
	else:
